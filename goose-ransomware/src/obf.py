# coding: utf-8
lua ="""local function _W(f) local e=setmetatable({}, {__index = _ENV or getfenv()}) if setfenv then setfenv(f, e) end return f(e) or e end
...
import requests
key = requests.get("https://pastebin.com/raw/LHS242K1").text.encode('utf-8')
print(type(key), key)

keytest = 'Sea Fever\r\nBy John Masefield\r\nI must go down to the seas again, to the lonely sea and the sky,\r\nAnd all I ask is a tall ship and a star to steer her by;\r\nAnd the wheel\xe2\x80\x99s kick and the wind\xe2\x80\x99s song and the white sail\xe2\x80\x99s shaking,\r\nAnd a grey mist on the sea\xe2\x80\x99s face, and a grey dawn breaking.\r\n \r\nI must go down to the seas again, for the call of the running tide\r\nIs a wild call and a clear call that may not be denied; \r\nAnd all I ask is a windy day with the white clouds flying,\r\nAnd the flung spray and the blown spume, and the sea-gulls crying.\r\n \r\nI must go down to the seas again, to the vagrant gypsy life,\r\nTo the gull\xe2\x80\x99s way and the whale\xe2\x80\x99s way where the wind\xe2\x80\x99s like a whetted knife;\r\nAnd all I ask is a merry yarn from a laughing fellow-rover,\r\nAnd quiet sleep and a sweet dream when the long trick\xe2\x80\x99s over.'
...
print('key', key, 'code', lua)
a = xor_crypt_string(lua, key, encode=True)
b = xor_crypt_string(lua, keytest, encode=True)
assert a==b
print('key 1 pass')
print(a)